...
| 8 | GET | `/api/companies-duplicate-cleanup/origins` | token | HTTP 200, body is a JSON array of origin strings |
...
8  GET /api/companies-duplicate-cleanup/origins      200     PASS
```

5. If any test fails, show the full response body for that test below the table.
6. End with a one-line summary: "8/8 passed" or "5/8 passed — see failures above".
